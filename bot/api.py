...
# ---------------------------------------------------------------------------------------------
def send_command(token, voice, text, output, type="mp3", wordpos="off", mouthpos="off", dico="", application="",
                 volume="32768", shaping="100", speed="100", samplerate="", bitrate=""):
    # Send command
    headers = {
        'Authorization': 'Token ' + token,
        'Content-Type': 'application/json',
    ...
    params = {'voice': voice, 'output': output, 'text': text, 'type': type, 'wordpos': wordpos, 'mouthpos': mouthpos,
              'dico': dico, 'application': application, 'volume': volume, 'shaping': shaping, 'speed': speed,
...
# ---------------------------------------------------------------------------------------------
def send_command_post(token, voice, text, output, type="mp3", wordpos="off", mouthpos="off", dico="", application="",
                      volume="32768", shaping="100", speed="100", samplerate="", bitrate=""):
    # Send command
    headers = {
        'Authorization': 'Token ' + token,
