...
class TranslationSerializer(serializers.Serializer):
    source_language = serializers.CharField(max_length=10, default='eng', required=False)
    target_language = serializers.CharField(max_length=10, default='sme', required=False)
